          ...
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              ...
              <p className=" mt-2 text-base text-muted-foreground">
                ...
                it. So hang tight we&apos;ll sent you confirmation soon
              </p>
            )}
            <div className=" mt-16 text-sm font-medium">
              ...
              <div className=" space-y-6 border-t border-gray-200 pt-6 text-sm text-muted-foreground font-medium">
                ...
                <div className=" flex items-center justify-between border-t border-gray-200 pt-6 text-gray-900">
                    ...
                    <p className="text-base text-gray-900">{formatPrice(orderTotal + fee)}</p>
                </div>
              </div>
              <PaymentStatus isPaid={order._isPaid} orderId={order.id} orderEmail={(order.user as User).email} />
